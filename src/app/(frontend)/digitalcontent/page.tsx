                  ...
                  >
                    {block.areas?.map((area: any, areaIndex: number) => (
                      ...
                      >
                        ...
                        <div style={{ flex: 1 }}>
                          <h3 style={{ fontSize: '1.5rem', marginBottom: '12px', color: 'black' }}>
                            {area.title}
                          </h3>
                ...
                >
                  {block.items?.map((item: any, itemIndex: number) => (
                    ...
                    >
                      ...
                      <h3 style={{ fontSize: '1.25rem', marginBottom: '20px', minHeight: '60px' }}>
                        {item.title}
                      </h3>
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  {block.questions?.map((item: any, faqIndex: number) => (
                    ...
                    >
                      <h3 style={{ fontSize: '1.5rem', marginBottom: '12px' }}>{item.question}</h3>
                      <div
